...
- The physical world is real in the full causal-consequence sense. — Source: `/src/content/chapters/10-the-information-physical-duality.md`
- The informational world is also real: beliefs, distinctions, models, meanings, identities, norms, and institutions exist and do work. — Source: `/src/content/chapters/10-the-information-physical-duality.md`
- Information is not merely physical: the same information can run on different substrates and still do the same job. — Source: `/src/content/chapters/10-the-information-physical-duality.md`
- Physical and informational layers are coupled: changes on one side propagate to the other. — Source: `/src/content/chapters/10-the-information-physical-duality.md`
- Treating either layer as primary causes characteristic blindness. Pure materialists are confused by why anyone fights for symbols; pure idealists are confused by why people get hungry. — Source: `/src/content/chapters/10-the-information-physical-duality.md`
