...
subtitle: "The lowest common denominator of life"
act: volo-ergo-sum
actTitle: "Volo Ergo Sum"
chapterNumber: 1
order: 1
summary: "A being does not first know. A being first leans. Before ideology, before metaphysics, before language: attraction, aversion, care, preference, will. This chapter explains why there is any motion, any action, any value, any difference at all."
...
This is what we mean by *Volo ergo sum*. Not a swap of one slogan for another, but a shift in where the floor is. Underneath cognition, underneath language, underneath the long arguments about what is real, there is a primal lean. Attraction. Aversion. Care. Everything else is built on top.

## Key moves

- The lowest common denominator of life is not knowing — it is wanting, in the broad sense of attraction, aversion, care, preference, and lean.
- Want is observable from the outside (a paramecium turns toward food) and from the inside (you can find your own want in any moment by checking where your attention is leaning).
- "Thought" presupposes a thinker oriented toward something. That orientation is want. So thought rides on want, not the other way around.
...
- Treating want as primal lets us talk about microbes, mammals, and humans on a continuum without flattening any of them.
- Refusing to start with want forces you to invent ghosts (souls, pure reason, free-floating subjects) to do the work that wanting was already doing.
...
- Self-knowledge starts as want-knowledge. You learn what you are by watching what you lean toward when nobody is grading you.

## What we're not claiming

- Not that humans are "just" wanting machines. The wanting layer is the floor, not the ceiling.
