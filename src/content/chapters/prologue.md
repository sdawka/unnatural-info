...
subtitle: "A body, a shared world, and the pictures between them"
act: prologue
order: 0
summary: "Ordinary maintenance opens onto a larger question: how natural creatures make knowledge, institutions, and technologies that alter the shared material world which made them. The book offers a revisable frame for noticing that loop."
...
furtherReading:
  - author: "William James"
    ...
    year: 1912
    note: "A case for beginning with experience while judging ideas by what they do in lived inquiry."
  - author: "Thomas Nagel"
    title: "What Is It Like to Be a Bat?"
    year: 1974
    note: "A reminder that a description from outside does not exhaust what experience is like from inside."
...
But the body does something stranger as well. It makes pictures: marks on paper, remembered routes, recipes, promises, warnings, stories about what happened and what should happen next. Some pictures are private for a moment. Others get copied into calendars, building plans, laws, textbooks, software, and family habits. A group can keep a hard-won lesson alive in a water rule or a safety procedure. A design can recruit steel, labor, money, and a century of borrowed knowledge into a bridge. Then the pictures return to matter. A recipe changes a cupboard. A diagram changes a bridge. A sentence changes where somebody goes on Tuesday.

That return trip is the book's large, slightly embarrassing question: what are we, that a natural creature can make information and use it to reshape the physical world that made it? **Unnatural** is the name used here for that oddness. It does not mean outside nature, above nature, or in a quarrel with rocks. It means that nature has produced beings able to make representations, pass them around, and let them reorganize what happens next. We do this alone in small ways and together in ways that become knowledge, technologies, institutions, and shared obligations.
