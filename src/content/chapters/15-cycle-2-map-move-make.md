...
furtherReading:
  ...
  - author: "Tim Ingold"
    ...
    year: 2000
    note: "Wayfinding as skilled practice: you don't follow a map, you navigate a world. Movement creates knowledge."
  - author: "Richard Sennett"
    title: "The Craftsman"
    year: 2008
    note: "Making as a mode of understanding. The hand teaches the head. Skill develops through doing, not just knowing."
...
|-----------|-----|------|------|
| Single cell | Chemotactic gradient | Directed motility | Division, metabolism |
| Nervous system | Cognitive maps, affordances | Skilled movement, navigation | Behavior, tool use |
